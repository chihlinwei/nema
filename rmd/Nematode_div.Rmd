...
p1 <- ggplot(data=subset(cbind(h1, e), Sample!="OR1_1126_GC2_1_9_2"), 
...
```{r, fig.width=4.5, fig.height=4}
p2 <- ggplot(data=subset(cbind(h1, e), Sample!="OR1_1126_GC2_1_9_2"), 
...
```{r, fig.width=4.5, fig.height=4}
p3 <- ggplot(data=subset(cbind(h1, e), Sample!="OR1_1126_GC2_1_9_2"), 
...
```{r, fig.width=4.5, fig.height=4}
p4 <- ggplot(data=subset(cbind(h1, e), Sample!="OR1_1126_GC2_1_9_2"), 
