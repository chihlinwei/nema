...
names(env)[5:19] <- c("Spd", "O20", "Tem", "Sal", "Den", "Oxy", "Flu", "Tra", "Cla", "Sil", "San", "CN", "TOC", "TN", "Por")

env2 <- melt(env, id.vars=c("Habitat", "Cruise", "Station", "Depth"), measure.vars=c("Spd", "O20", "Tem", "Sal", "Den", "Oxy", "Flu", "Tra", "Cla", "Sil", "San", "CN", "TOC", "TN", "Por"))
